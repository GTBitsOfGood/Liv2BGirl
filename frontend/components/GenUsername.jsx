...
const GenUsername = props => {
  ...
  const usernames = [[genUser(), genUser(), genUser()], [genUser(),
    genUser(), genUser()], [genUser(), genUser(), genUser()]]
  ...
  return (
    <div>
        ...
        <Button onClick={() => {setGenerate(true)}} style={{outlineColor:'lightgray', 
          backgroundColor:'lightgray', height:30, WebkitBorderRadius:40, color:'black',
          paddingBottom:28}}>
             Generate! 
        </Button>
        <br></br>
        ...
        {generate && describe != "" && like != "" && lucky != "" && 
          usernames.map((name, i) => {
            return <div style={{alignItems:'center'}}>
                <Button 
                onClick={(e) => {setUsername(name[0])}}
                style={{marginRight:25, marginBottom:20, height:40, width:100,
                 fontSize:11, WebkitBorderRadius: 30, color:'gray', backgroundColor:'white'}}> 
                {name[0]} 
                </Button>

                <Button 
                onClick={(e) => {setUsername(name[1])}}
                style={{marginRight:25, marginBottom:20, height:40, width:100, 
                fontSize:11, WebkitBorderRadius: 30, color:'gray', backgroundColor:'white'}}> 
                {name[1]} 
                </Button>
                ...
                <Button 
                onClick={(e) => {setUsername(name[2])}}
                style={{marginBottom:20, height:40, width:100, fontSize:11,
                WebkitBorderRadius: 30, color:'gray', backgroundColor:'white'}}> 
                {name[2]} 
                </Button> 
                <br></br>
              </div>
        ...
        <Button style={{outlineColor:'lightgray', 
          backgroundColor:'lightgray', marginLeft:130, height:30, 
          WebkitBorderRadius:40, color:'black', paddingBottom:28}}> 
          Next Step 
        </Button>
    </div>
